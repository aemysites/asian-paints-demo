...
## Environments
- Preview: https://main--asian-paints-demo--aemysites.aem.page/
- Live: https://main--asian-paints-demo--aemysites.aem.live/
- Block Library: https://main--asian-paints-demo--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `asian-paints-demo` directory in your favorite IDE and start coding :)
